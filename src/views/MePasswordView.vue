...
<template>
  <section class="mx-auto max-w-md">
    ...
    <div v-if="loading" class="mt-6 text-center text-sm text-slate-500">載入中…</div>

    <template v-else>
      <div v-if="success" class="mt-6 rounded-md border border-emerald-200 bg-emerald-50 p-4">
